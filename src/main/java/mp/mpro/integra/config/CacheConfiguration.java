...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, mp.mpro.integra.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, mp.mpro.integra.repository.UserRepository.USERS_BY_EMAIL_CACHE);
