...
import static mp.mpro.integra.test.util.OAuth2TestUtil.TEST_USER_LOGIN;
import static mp.mpro.integra.test.util.OAuth2TestUtil.registerAuthenticationToken;
import static mp.mpro.integra.test.util.OAuth2TestUtil.testAuthenticationToken;
import static org.springframework.test.web.servlet.request.MockMvcRequestBuilders.get;
import static org.springframework.test.web.servlet.result.MockMvcResultMatchers.*;

import mp.mpro.integra.IntegrationTest;
import mp.mpro.integra.security.AuthoritiesConstants;
